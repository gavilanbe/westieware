...
**Anahí Gavilán** en el Carrer de Viladomat, 185 (Eixample, Barcelona), con
**Keiko**, su westie, de mascota. Es un homenaje a *WarioWare: Touched!*
(Nintendo DS) hecho entero a mano para este juego: fuentes, pixel art, música,
transiciones y hasta la consola.
...
- **Arranque**: el aviso de salud y seguridad de la DS en versión parodia
  («Antes de jugar, acaricia a tu perro») y el cartel de Westie BLVRD, que cae y ladra.
- **Pantalla de título** con Keiko en el emblema y los personajes que ya conoces
  asomando. Si nadie la toca, arranca una demo que se juega sola.
...
en cada acierto, temblor de pantalla, *squash & stretch*, destellos, sellos que
caen con muelle al ganar o perder, textos que entran letra a letra, la bomba que
chisporrotea y explota en espuma, el LED de la consola que parpadea en los
últimos pulsos, vibración en Android y un sonido para cada gesto. La música de
cada tramo se programa sobre el reloj de audio para caer justo en el pulso.
...
- `tools/shot.sh` hace capturas; `tools/sheet.sh <fase>` monta la lámina de revisión
  de una fase con un solo Chrome (cada captura va en un iframe de `tools/grid.html`);
...
Juego de fans, sin relación con Nintendo. Idea de Nahuel Gavilán, con ideas
sacadas de su propio vídeo parodia; programación, arte y música de Claude Opus 5.5.
